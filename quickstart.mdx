...
- Explore the [API Reference](/api/orders/create-order) for detailed endpoint documentation
- Learn about the [architecture and design patterns](/concepts/architecture) used in the service
- Set up [configuration options](/guides/configuration) for database, RabbitMQ, and application properties
- Deploy the service to different environments using the [deployment guide](/guides/deployment)
